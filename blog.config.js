...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Terry 老师', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '全能型英语教育博主', // 作者简介
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-2D23JpEjuA', // Remove the value or replace it with your own google site verification code
